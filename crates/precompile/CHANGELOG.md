...
## [42.0.0](https://github.com/baoguomarshall/revm/compare/revm-precompile-v41.0.0...revm-precompile-v42.0.0) - 2026-07-23

### Other

- *(deps)* bump dependencies ([#3794](https://github.com/baoguomarshall/revm/pull/3794))
- *(precompile)* reduce bounds checks in precompile parsing ([#3784](https://github.com/baoguomarshall/revm/pull/3784))
