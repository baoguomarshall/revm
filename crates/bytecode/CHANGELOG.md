...
## [9.1.0](https://github.com/baoguomarshall/revm/compare/revm-bytecode-v9.0.0...revm-bytecode-v9.1.0) - 2026-03-21
...
- make Bytecode Ord consistent with PartialEq and Hash ([#3479](https://github.com/baoguomarshall/revm/pull/3479))
