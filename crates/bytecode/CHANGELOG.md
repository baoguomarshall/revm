...
## [41.0.1](https://github.com/baoguomarshall/revm/compare/revm-bytecode-v41.0.0...revm-bytecode-v41.0.1) - 2026-07-23

### Fixed

- *(bytecode)* preserve iterator position after truncated push ([#3800](https://github.com/baoguomarshall/revm/pull/3800))
- *(bytecode)* avoid iterating legacy padding opcodes ([#3792](https://github.com/baoguomarshall/revm/pull/3792))

### Other

- *(bytecode)* cover InvalidMagic and verify EIP-7702 magic constants ([#3806](https://github.com/baoguomarshall/revm/pull/3806))
- *(deps)* bump dependencies ([#3794](https://github.com/baoguomarshall/revm/pull/3794))
- *(bytecode)* cover all truncated pushes ([#3783](https://github.com/baoguomarshall/revm/pull/3783))

## [41.0.0](https://github.com/bluealloy/revm/compare/revm-bytecode-v11.0.1...revm-bytecode-v41.0.0) - 2026-06-11

### Fixed

- *(bytecode)* avoid out-of-bounds pointer in analyze_legacy ([#3752](https://github.com/bluealloy/revm/pull/3752))
