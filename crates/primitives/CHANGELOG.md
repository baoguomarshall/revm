...
## [4.0.0](https://github.com/baoguomarshall/revm/compare/revm-primitives-v3.1.1...revm-primitives-v4.0.0) - 2024-04-23

### Added
- add `Bytecode::original_bytecode_slice` to match `BytecodeLocked` ([#1286](https://github.com/baoguomarshall/revm/pull/1286))
...
- pass rand feature to alloy_primitives ([#1276](https://github.com/baoguomarshall/revm/pull/1276))
- *(interpreter)* remove SPEC generic from gas calculation functions ([#1243](https://github.com/baoguomarshall/revm/pull/1243))

### Other
- Implement `with_chain_id` for `CfgEnv` ([#1327](https://github.com/baoguomarshall/revm/pull/1327))
