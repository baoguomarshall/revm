...
## [8.0.0](https://github.com/baoguomarshall/revm/compare/revm-primitives-v7.1.0...revm-primitives-v8.0.0) - 2024-08-07
...
### Fixed
- *(EOF)* Overflow on num_sections ([#1656](https://github.com/baoguomarshall/revm/pull/1656))

### Other
- Add OP-Granite hardfork, limiting bn256Pairing input size ([#1685](https://github.com/baoguomarshall/revm/pull/1685))
- Renamed some city name ([#1645](https://github.com/baoguomarshall/revm/pull/1645))
