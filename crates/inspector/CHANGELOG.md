...
## [17.1.0](https://github.com/baoguomarshall/revm/compare/revm-inspector-v17.0.0...revm-inspector-v17.1.0) - 2026-03-21
...
- ensure both inspectors receive paired call/create events in tuple impl ([#3473](https://github.com/baoguomarshall/revm/pull/3473))
