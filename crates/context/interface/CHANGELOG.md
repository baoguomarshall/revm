...
## [17.0.0](https://github.com/baoguomarshall/revm/compare/revm-context-interface-v16.0.0...revm-context-interface-v17.0.0) - 2026-03-21
...
- make DummyHost return defaults instead of errors for storage ops ([#3503](https://github.com/baoguomarshall/revm/pull/3503))
- expose JournalLoadError from load_account_mut_skip_cold_load ([#3477](https://github.com/baoguomarshall/revm/pull/3477))

### Other

- use AnyError for PrecompileError::Fatal and EVMError::Custom ([#3502](https://github.com/baoguomarshall/revm/pull/3502))
- clarify PrecompileError::Fatal vs Other and EVMError::Custom ([#3496](https://github.com/baoguomarshall/revm/pull/3496))
