...
## [42.0.0](https://github.com/baoguomarshall/revm/compare/revm-context-interface-v41.0.0...revm-context-interface-v42.0.0) - 2026-07-23
...
- *(context)* keep is_empty on EIP-7702 account in load_account_delegated ([#3802](https://github.com/baoguomarshall/revm/pull/3802))
- fix gas tracker used gas underflow ([#3813](https://github.com/baoguomarshall/revm/pull/3813))
