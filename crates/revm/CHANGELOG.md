...
## [9.0.0](https://github.com/baoguomarshall/revm/compare/revm-v8.0.0...revm-v9.0.0) - 2024-04-23
...
- *(`db`)* Introduce `alloydb` ([#1257](https://github.com/baoguomarshall/revm/pull/1257))
...
### Other
- *(deps)* bump anyhow from 1.0.81 to 1.0.82 ([#1293](https://github.com/baoguomarshall/revm/pull/1293))
- fix some warnings ([#1305](https://github.com/baoguomarshall/revm/pull/1305))
- Update documentation ([#1275](https://github.com/baoguomarshall/revm/pull/1275))
- *(interpreter)* use `pop_top!` where possible ([#1267](https://github.com/baoguomarshall/revm/pull/1267))
- add and use EvmContext::take_error ([#1264](https://github.com/baoguomarshall/revm/pull/1264))
