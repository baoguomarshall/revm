...
## [7.2.1](https://github.com/baoguomarshall/revm/compare/revm-v7.2.0...revm-v7.2.1) - 2024-03-25

### Fixed
- fix eip3155 summary gas_used bug and add fork name ([#1216](https://github.com/baoguomarshall/revm/pull/1216))

### Other
- Improve `EthersDB` ([#1208](https://github.com/baoguomarshall/revm/pull/1208))
