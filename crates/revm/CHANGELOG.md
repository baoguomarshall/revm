...
## [12.2.0](https://github.com/baoguomarshall/revm/compare/revm-v12.1.0...revm-v12.2.0) - 2024-08-07

### Added
- *(EOF)* EOF Validation add code type and sub container tracker ([#1648](https://github.com/baoguomarshall/revm/pull/1648))

### Other
- Add OP-Granite hardfork, limiting bn256Pairing input size ([#1685](https://github.com/baoguomarshall/revm/pull/1685))
- *(deps)* bump rstest from 0.21.0 to 0.22.0 ([#1681](https://github.com/baoguomarshall/revm/pull/1681))
- *(deps)* bump tokio from 1.38.1 to 1.39.2 ([#1668](https://github.com/baoguomarshall/revm/pull/1668))
...
- *(eof)* simplify magic checks ([#1633](https://github.com/baoguomarshall/revm/pull/1633))
