...
## [7.0.0](https://github.com/baoguomarshall/revm/compare/revm-interpreter-v6.0.0...revm-interpreter-v7.0.0) - 2024-07-01

### Added
- add bytecode_address from CallInputs to Contract during construction. ([#1568](https://github.com/baoguomarshall/revm/pull/1568))
- support selfdestruct for dummyhost ([#1578](https://github.com/baoguomarshall/revm/pull/1578))
...
### Fixed
- *(eof)* ExtDelegateCall caller/target switch ([#1571](https://github.com/baoguomarshall/revm/pull/1571))
