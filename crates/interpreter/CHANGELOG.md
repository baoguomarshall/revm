...
## [3.5.0](https://github.com/baoguomarshall/revm/compare/revm-interpreter-v3.4.0...revm-interpreter-v3.5.0) - 2024-03-25

### Added
- *(interpreter)* expose mutable access methods on stack and memory ([#1219](https://github.com/baoguomarshall/revm/pull/1219))
